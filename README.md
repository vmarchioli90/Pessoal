...
| --- | --- | --- | --- |
| Web | Validar buscas com e sem resultados no Blog do Agi | Playwright, JavaScript, Node.js | 2 cenários bloqueados por [defeito da interface pública](docs/bugs/BUG-001-blog-search-overlay.md) |
...
### Estado atual da frente Web

A suíte Web permanece intencionalmente vermelha porque a lupa do site público não abre o campo de busca. O comportamento foi reproduzido localmente e no GitHub Actions e está formalizado no [BUG-001](docs/bugs/BUG-001-blog-search-overlay.md). O teste não foi ignorado nem adaptado para contornar o defeito, preservando o valor da evidência de QA.
...
|-- docs/bugs/                         # Defeitos externos formalmente registrados
...
- [Bug report da busca Web](docs/bugs/BUG-001-blog-search-overlay.md)
- [Licença MIT](LICENSE)
